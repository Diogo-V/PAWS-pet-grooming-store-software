...
class WindowAppointment(Toplevel):
    ...
    def __init__(self, master, appointmentID):
        ...
        Separator(self.petWindow, orient=HORIZONTAL).grid(column=0, row=1, sticky='ew')
        Label(self.petWindow, text=f'Tipo de animal:  {petType}').grid(column=0, row=2, sticky='w', pady=35)
        Separator(self.petWindow, orient=HORIZONTAL).grid(column=0, row=3, sticky='ew')
        ...
        Separator(self.petWindow, orient=HORIZONTAL).grid(column=0, row=7, sticky='ew')
        ...
        Separator(self.clientWindow, orient=HORIZONTAL).grid(column=0, row=1, sticky='ew')
        Label(self.clientWindow, text=f'NIF:  {clientNIF}').grid(column=0, row=2, sticky='w', pady=35)
        Separator(self.clientWindow, orient=HORIZONTAL).grid(column=0, row=3, sticky='ew')
        ...
        Separator(self.appointmentWindow, orient=HORIZONTAL).grid(column=0, row=1, sticky='ew')
        Label(self.appointmentWindow, text=f'Dia:  {appDate}').grid(column=0, row=2, sticky='w', pady=35)
        Separator(self.appointmentWindow, orient=HORIZONTAL).grid(column=0, row=3, sticky='ew')
        Label(self.appointmentWindow, text=f'Hora:  {appTime}').grid(column=0, row=4, sticky='w', pady=35)
        Separator(self.appointmentWindow, orient=HORIZONTAL).grid(column=0, row=5, sticky='ew')
